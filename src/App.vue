    ...
    <div class="sticky flex h-16 justify-between bg-black w-full ">
      <div class="flex">
        ...
        <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
          ...
          <router-link class="inline-flex items-center border-b-4 hover:border-blue px-1 pt-1 text-sm font-medium text-white"
            to="/">登入</router-link>
          <router-link
            class="inline-flex items-center border-b-4 border-transparent px-1 pt-1 text-sm font-medium text-white hover:border-blue hover:text-lg hover:font-bold"
            to="/resume">履歷表</router-link>
          <router-link
            class="inline-flex items-center border-b-4 border-transparent px-1 pt-1 text-sm font-medium text-white hover:border-blue hover:text-lg hover:font-bold"
            to="message">留言板</router-link>
          <router-link
            class="inline-flex items-center border-b-4 border-transparent px-1 pt-1 text-sm font-medium text-white hover:border-blue hover:text-lg hover:font-bold"
            to="register">註冊</router-link>
        </div>
      </div>
